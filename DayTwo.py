...
def compare_images(image1_path, image2_path):
    ...
    if image1 is None or image2 is None:
        ...
        return
    # Resize the images to the same dimensions for comparison[VERY IMPORTANT]
    image1 = cv2.resize(image1, (500, 500))
    image2 = cv2.resize(image2, (500, 500))
    
    #calculating difference between two images(CHECKING ALL ASPECTS)
...
# Call the function to compare the images{ENDING}
